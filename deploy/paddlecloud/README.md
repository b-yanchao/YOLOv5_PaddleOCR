...
```bash
# 下载预训练模型到/home/YOLOv5_PaddleOCR/pre_train文件夹下
$ mkdir /home/YOLOv5_PaddleOCR/pre_train

$ wget -P /home/YOLOv5_PaddleOCR/pre_train https://paddleocr.bj.bcebos.com/PP-OCRv3/chinese/ch_PP-OCRv3_det_distill_train.tar

$ tar xf /home/YOLOv5_PaddleOCR/pre_train/ch_PP-OCRv3_det_distill_train.tar -C /home/YOLOv5_PaddleOCR/pre_train/
```
