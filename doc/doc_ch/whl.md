...
img_path = 'YOLOv5_PaddleOCR/doc/imgs_words/ch/word_1.jpg'
...
```bash
paddleocr --image_dir YOLOv5_PaddleOCR/doc/imgs/11.jpg --use_angle_cls true
```
...
```bash
paddleocr --image_dir YOLOv5_PaddleOCR/doc/imgs/11.jpg
```
...
```bash
paddleocr --image_dir YOLOv5_PaddleOCR/doc/imgs_words/ch/word_1.jpg --use_angle_cls true --det false
```
...
```bash
paddleocr --image_dir YOLOv5_PaddleOCR/doc/imgs/11.jpg --rec false
```
...
```bash
paddleocr --image_dir YOLOv5_PaddleOCR/doc/imgs_words/ch/word_1.jpg --det false
```
...
```bash
paddleocr --image_dir YOLOv5_PaddleOCR/doc/imgs_words/ch/word_1.jpg --use_angle_cls true --det false --rec false
```
