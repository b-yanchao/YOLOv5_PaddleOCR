...
img_path = 'YOLOv5_PaddleOCR/doc/imgs_en/img_12.jpg'
...
im_show = draw_ocr(image, boxes, txts, scores, font_path='/path/to/YOLOv5_PaddleOCR/doc/fonts/simfang.ttf')
...
img_path = 'YOLOv5_PaddleOCR/doc/imgs_words_en/word_10.png'
...
image = Image.open(img_path).convert('RGB')
im_show = draw_ocr(image, result, txts=None, scores=None, font_path='/path/to/YOLOv5_PaddleOCR/doc/fonts/simfang.ttf')
im_show = Image.fromarray(im_show)
im_show.save('result.jpg')
```
...
```bash
paddleocr --image_dir YOLOv5_PaddleOCR/doc/imgs_en/img_12.jpg --use_angle_cls true --lang en
```
...
* detection and recognition
```bash
paddleocr --image_dir YOLOv5_PaddleOCR/doc/imgs_en/img_12.jpg --lang en
```
...
* classification and recognition
```bash
paddleocr --image_dir YOLOv5_PaddleOCR/doc/imgs_words_en/word_10.png --use_angle_cls true --det false --lang en
```
...
* only detection
```bash
paddleocr --image_dir YOLOv5_PaddleOCR/doc/imgs_en/img_12.jpg --rec false
```
...
* only recognition
```bash
paddleocr --image_dir YOLOv5_PaddleOCR/doc/imgs_words_en/word_10.png --det false --lang en
```
...
* only classification
```bash
paddleocr --image_dir YOLOv5_PaddleOCR/doc/imgs_words_en/word_10.png --use_angle_cls true --det false --rec false
```
...
```bash
paddleocr --image_dir YOLOv5_PaddleOCR/doc/imgs/11.jpg --det_model_dir {your_det_model_dir} --rec_model_dir {your_rec_model_dir} --rec_char_dict_path {your_rec_char_dict_path} --cls_model_dir {your_cls_model_dir} --use_angle_cls true
```
...
ocr = PaddleOCR(use_angle_cls=True, lang="ch") # need to run only once to download and load model into memory
img_path = 'YOLOv5_PaddleOCR/doc/imgs/11.jpg'
