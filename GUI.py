...
class MyFrame(wx.Frame):
	...
	def __init__(self, parent):
		wx.Frame.__init__(self, parent, id=wx.ID_ANY, title=u"复杂场景下的标签内容识别系统", pos=wx.DefaultPosition, size=wx.Size(1383, 770), style=wx.DEFAULT_FRAME_STYLE | wx.TAB_TRAVERSAL)
		...
		self.m_staticText111 = wx.StaticText(sbSizer1.GetStaticBox(), wx.ID_ANY, u"选择识别图片的目录：", wx.DefaultPosition, wx.DefaultSize, 0)
		...
		self.m_dirPickertxt = wx.DirPickerCtrl(sbSizer1.GetStaticBox(), wx.ID_ANY, u"请选择或者输入", u"Select a folder", wx.DefaultPosition, wx.Size( 600,-1 ), wx.FLP_DEFAULT_STYLE )
		gbSizer1.Add(self.m_dirPickertxt, wx.GBPosition(3, 1), wx.GBSpan(1, 1), wx.ALL, 5)

		self.m_staticText9 = wx.StaticText(sbSizer1.GetStaticBox(), wx.ID_ANY, u"*选择目录时必选", wx.DefaultPosition, wx.DefaultSize, 0)
		...
		self.m_dirPickerpic = wx.DirPickerCtrl(sbSizer1.GetStaticBox(), wx.ID_ANY, u"请选择或者输入", u"Select a folder", wx.DefaultPosition, wx.Size(600, -1), wx.DIRP_DEFAULT_STYLE)
		gbSizer1.Add(self.m_dirPickerpic, wx.GBPosition(2, 1), wx.GBSpan(1, 1), wx.ALL, 5)

		self.m_staticText10 = wx.StaticText(sbSizer1.GetStaticBox(), wx.ID_ANY, u"*选择目录时必选", wx.DefaultPosition, wx.DefaultSize, 0)
		...
		self.m_staticText5 = wx.StaticText(sbSizer10.GetStaticBox(), wx.ID_ANY, u"识别结果图：", wx.DefaultPosition, wx.DefaultSize, 0)
		self.m_staticText5.Wrap(-1)

		gbSizer11.Add(self.m_staticText5, wx.GBPosition(0, 3), wx.GBSpan(1, 1), wx.ALL, 5)

		self.m_staticText6 = wx.StaticText(sbSizer10.GetStaticBox(), wx.ID_ANY, u"格式化输出信息：", wx.DefaultPosition, wx.DefaultSize, 0)
	...
	def btn_shibie_n_pic(self, event):
		...
		# txt文件要保存的位置
		self.save_txt_path = self.m_dirPickertxt.Path

		# 图片要保存的目录位置
		self.save_pic_path = self.m_dirPickerpic.Path

		#开始识别图片
		res, one_qian_pic_path, one_hou_pic_path, n_qian_pic_path, n_hou_pic_path = n_pre.pre_save(self.dirPath, self.save_pic_path, self.save_txt_path)
