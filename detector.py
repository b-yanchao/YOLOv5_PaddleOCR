...
class Detector:
    ...
    def detect(self, im):
        ...
        pred = pred.float()
        pred = non_max_suppression(pred, 0.3, 0.45, agnostic=False)  # 进行非极大值抑制，对其中confidence较低的box和IOU较大的box进行过滤
        #         pred = non_max_suppression(pred, 0.1, 0.8, agnostic=False)#进行非极大值抑制，对其中confidence较低的box和IOU较大的box进行过滤 20220721_09:45瞎改的。
